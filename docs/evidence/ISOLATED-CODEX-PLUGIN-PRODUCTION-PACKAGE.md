...
包内没有 `.app.json`、`.mcp.json`、hooks、scripts 或 `.agents`，也不包含白名单以外的资产、账号、后端、密钥、个人路径或 Marketplace 配置。主 SVG 保持用户接受的 SHA-256 `27c5a8566bb4d7800f9250715aef649adf5806b35784955a093cc37cf477238a`；暗色版只替换主线颜色且几何相同。源 Skill path/hash manifest SHA-256 为 `acbd6d6668d0e8fc34ea7585db5c758cc09a9ea08756f7a52b84f4a5b841ba1b`；完整包 path/hash manifest SHA-256 为 `be76ac16cb3d19d95e5803f5581bdf0e07285bf1f67b65767268d8dd0aa00070`。
...
所有进入包体的 `codex-skills/**`、manifest、SVG、LICENSE、NOTICE、第三方 notices/来源登记和 MIT license 均由 `.gitattributes` 固定 `eol=lf`，PNG 固定为 binary。源摘要会在构建前再次验证，因此 Windows `core.autocrlf` 或其他检出策略不能静默改变发布字节。
